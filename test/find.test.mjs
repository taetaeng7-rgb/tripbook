...
test('matchDest — 도도부현(prefecture)으로도 검색', () => {
  const d = dest('카미코치', { prefecture: '나가노현' });
  assert.equal(matchDest(d, { themes: [], q: '나가노' }), true);
  assert.equal(matchDest(d, { themes: [], q: '군마' }), false);
});
