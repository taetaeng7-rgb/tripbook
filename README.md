...
- **월별 시즌 캘린더** — 매월 국내 3곳 + 해외 3곳 큐레이션 (72슬롯 · 여행지 60곳)
- **근거 중심 추천** — 기후 / 자연 / 축제 / 비용·혼잡 / 액티비티 5대 근거로 "왜 이 달인가"를 명시
- **도쿄 출발 실용 정보** — 이동시간·예산 레벨(¥~¥¥¥¥¥)·추천 일수·주의사항(태풍철 등)
- 홈은 **이번 달 자동 감지** + 다음 달 미리보기, 국내/해외는 하단 탭에서 완전 분리 브라우즈
...
## 상태
**MVP 구현 완료 (v0.1)** — 홈 / 월별 캘린더 / 국내·해외 브라우즈 / 상세("왜 이 달인가") / 다크모드.
시드: 여행지 60곳(국내 28·해외 32), 12개월 × 국내 3+해외 3 큐레이션.
