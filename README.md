...
- **월별 시즌 캘린더** — 매월 국내 3곳 + 해외 3곳 큐레이션 + "이 달의 다른 후보" 자동 도출 (여행지 142곳)
...
## 상태
**v0.2 — P1 기능 완료** — 찾기·검색 / 위시리스트·가봤음 / 연휴 오버레이 / 월별 "다른 후보".
콘텐츠: 여행지 142곳(국내 75·해외 67), 12개월 × 국내 3+해외 3 큐레이션 + bestMonths 기반 후보 풀.
